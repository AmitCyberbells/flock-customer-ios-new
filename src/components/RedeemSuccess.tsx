...
interface RedeemOfferSuccessProps {
  visible: boolean;
  onClose: () => void;
  offer?: Offer;
}

const RedeemOfferSuccess: React.FC<RedeemOfferSuccessProps> = ({
  visible,
  onClose,
  offer
}) => {
            ...
            >
              ...
              <View style={styles.section}>
                ...
                <View style={styles.currentPointsRow}>
                  <TouchableOpacity onPress={() => setRedeemBy('feather_points')} style={{ flex: 1 }} activeOpacity={0.9}>
                  ...
                  <TouchableOpacity onPress={() => setRedeemBy('venue_points')} style={{ flex: 1 }} activeOpacity={0.9}>
...
export default RedeemOfferSuccess;